...
from .model import LABELS, LaBSEEfficientGlobalPointer
...
def _move_batch(
    ...
    """Move all batch tensors to the inference device."""
...
def select_non_overlapping(candidates: list[JsonObject]) -> list[JsonObject]:
    """Greedily retain the highest-scoring non-overlapping spans."""
...
def predict_records(
    ...
    *,
    ...
    """Predict exact character spans and merge scores from overlapping windows."""
    ...
    def process_batch(
        ...
        """Score and decode one buffered batch of token windows."""
